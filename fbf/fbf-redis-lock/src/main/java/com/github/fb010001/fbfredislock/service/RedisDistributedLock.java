package com.github.fb010001.fbfredislock.service;

import com.github.fb010001.fbfredislock.utils.log.LogConfig;
            ...
            Long result = redisTemplate.execute(new RedisCallback<Long>() {
                public Long doInRedis(RedisConnection connection) throws DataAccessException {
                    ...
                    // 单机模式
                        ...
                        return (Long) ((RedisProperties.Jedis) nativeConnection).
